...
<div class="product__body">
  <div class="product__text-container">
          ...
          <ul class="product__categories">
            ...
            <li class="product__category">${category2}s</li>
      ...
      <footer class="product__footer">
        ...
        <button type="button" class="product__buy-button" data-js="buy_button">Buy</button>
      </footer>`
const buyButton = document.querySelector('[data-js="buy_button"]');
