...
function findByLastName(employees, lastName) {
  const employee = employees.find((employees) => employees.lastName.includes(lastName));
  return employee;
...
function findByCitySubString(employees, string) {
  const employee = employees.find((employees) => employees.city.includes(string));
  return employee;
}
...
function findByProfessionSubStringAndAge(employees, string, age) {
  const employee = employees.find((employees)=> employees.profession.includes(string) && employees.age > age);
  return employee;
}
